  ...
  return (
    <div className='flex-shrink-0 bg-red-400 w-[300px] h-[300px] rounded-xl p-5'>
      ...
      <div className='flex justify-between mt-4'>
        <button value={props.data.taskTitle} onClick={(e) => { handleAccept(e) }} className='bg-green-500 py-1 px-2 text-sm rounded-lg hover:bg-green-700'>Accpet</button>
        <button onClick={(e) => { handleReject(e) }} className='bg-green-500 py-1 px-2 text-sm rounded-lg hover:bg-green-700'>Reject</button>
